              ...
              <table className="w-full min-w-[520px] text-sm">
                ...
                <tbody>
                  {suppression.rowKeys.map((row) => (
                    <tr key={row} className="border-b border-hairline/60 last:border-0">
          ...
          <Card tone="dark" className="p-6 sm:p-8">
            <div className="flex flex-wrap items-center justify-between gap-4">
              ...
              <div className="flex flex-col items-stretch gap-2">
                ...
                <ButtonLink href="/research/deid/export/omop" variant="light">
                  Export OMOP bundle (ZIP · DUA required)
                </ButtonLink>
                <ButtonLink href="/research/deid/export/aggregate" variant="light">
...
function Field({
  ...
  return (
    <div className={`flex gap-3 ${highlight ? "rounded-card bg-cream/50 px-2 py-1 -mx-2" : ""}`}>
      <dt className="w-24 shrink-0 text-xs font-semibold tracking-wide text-graphite uppercase leading-5">
        {label}
      </dt>
      <dd
        className={
